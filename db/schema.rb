...
ActiveRecord::Schema.define(version: 2019_04_27_152233) do
  ...
  create_table "medical_diagnoses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["diagnosable_type", "diagnosable_id"], name: "index_medical_diagnoses_on_diagnosable_type_and_diagnosable_id"
  end
